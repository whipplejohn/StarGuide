...
const char* PARAM_INPUT_8 = "Manual";
const char* PARAM_INPUT_9 = "Calibrate";
...
<!DOCTYPE HTML><html><head>
    ...
    <style>
      ...
      h1 {
        color: red; width: 50%; margin-left: 25%; text-align: center; font-size: 26px; display: inline-block;padding-top: 15px;padding-bottom: 15px;
      }
      form {
          border: none;
          color: white;
    ...
    <form action="/get"> 
      <input type="submit" value="MANUAL" name="Manual">
